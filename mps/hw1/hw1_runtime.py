...
GPU_SPECS = {
    "Apple M2": {
        "label": "Apple M2 GPU",
        "peak_flops": 3.6e12,  # 3.6 TFLOP/s FP32
        "peak_bw": 100e9,      # 100 GB/s bandwidth
    },
    "Apple M": {
        "label": "Apple M-Series GPU",
        "peak_flops": 3.6e12,  # Typical M-series (e.g. M2 10-core GPU)
        "peak_bw": 100e9,      # Typical bandwidth (100 GB/s)
    },
}
...
def _get_gpu_specs():
    ...
    raise RuntimeError(
        f"Unsupported Apple GPU '{device_name}'."
    )
